...
export const generateTestItineraries = () => {
  ...
  return [
    ...
    // === CASE NORMALIZATION REGRESSION DATA ===
    // Casing test destination to validate title-case query values match lower-case stored userInfo values.
    {
      id: `test-casing-lowercase-match-${timestamp}`,
      userId: generateTestUserId(23),
      destination: 'Casingville, Testland',
      title: 'Casing Match Candidate',
      description: 'Lower-case userInfo fields for case-insensitive filter matching',
      startDate: dates.week1Start.toISOString(),
      endDate: dates.week1End.toISOString(),
      startDay: dates.week1StartMs,
      endDay: dates.week1EndMs,
      ...
      age: 29,
      likes: '[]',
      activities: '["City Walk", "Coffee"]',
      userInfo: {
        dob: '1996-01-01',
        uid: generateTestUserId(23),
        email: 'usertravaltest@gmail.com',
        gender: 'female',
        status: 'couple',
        blocked: [],
        username: 'TestUser_Casing_Lower',
        sexualOrientation: 'heterosexual',
      },
    },
    {
      id: `test-casing-lowercase-mismatch-${timestamp}`,
      userId: generateTestUserId(24),
      destination: 'Casingville, Testland',
      title: 'Casing Mismatch Candidate',
      description: 'Lower-case userInfo fields that should be filtered out by mixed-case queries',
      startDate: dates.week1Start.toISOString(),
      endDate: dates.week1End.toISOString(),
      startDay: dates.week1StartMs,
      endDay: dates.week1EndMs,
      ...
      userInfo: {
        dob: '1994-01-01',
        uid: generateTestUserId(24),
        email: 'usertravaltest@gmail.com',
        gender: 'male',
        status: 'single',
        blocked: [],
        username: 'TestUser_Casing_Mismatch',
        sexualOrientation: 'homosexual',
      },
    },
